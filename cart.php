                ...
                <table class="table table-bordered table-striped">
                    <tbody>
                       ...
                       <?php $counter=$counter+1;}?>
                        <tr>
                            <th></th><th>Total</th><th>Rs <?php echo $sum;?>/-</th>
                            <th>
                                <a href="cod_details.php?id=<?php echo $user_id?>&payment_method=cod" class="btn btn-primary">Cash on Delivery</a>
                                <a href="cod_details.php?id=<?php echo $user_id?>&payment_method=upi" class="btn btn-primary">UPI</a>
                            </th>
                        </tr>
                    </tbody>
                </table>
